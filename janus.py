...
class janus():
	def __init__(self, filename):
        ...
        #initialize devices
        self.eye_move = face_motor(pca, int(self.calfile['eye.movement']['channel'], 10), \
                                    int(self.calfile['eye.movement']['llim'], 16), \
                                    int(self.calfile['eye.movement']['ulim'],  16)) \
                                    int(self.calfile['eye.movement']['maxstep'],  16))
        
        self.eye_lid = face_motor(pca, int(self.calfile['eyelid.movement']['channel'], 10), \
